...
from .views import MyProfileView, UserProfileView, UserFollowingView, UserUnfollowingView, UsersPostView, FollowersView, FollowingsView
...
urlpatterns = [
    ...
    path('/<int:user_id>/follow', UserFollowingView.as_view({'post': 'create', 'get': 'list', 'delete': 'destroy'})),
